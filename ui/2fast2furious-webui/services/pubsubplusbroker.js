class PubSubPlusBroker {
   ...
   * @since 06-09-2018
   * @class
   * @classdesc PubSubPlusBroker interacts with an instance of PubSub+.
   *            Intended for Geekathon-Team-3, 2019.
   *            Derived from code written for the "Fundamentals of Solace Development" course.
   *
   *            Features
   *            ---------
   *            -Connecting to a broker.
   *            -Publish & subscribe to a topic on a broker.
   *            -Consume from a queue on a broker.
   */
  constructor() {
